                        ...
                        <a href="#" class="text-white">
                            <div class="media d-block d-sm-flex text-sm-left text-center"> <img src="/dist/images/profile-4.png" class="img-fluid d-sm-flex mr-0 mr-sm-4 border border-white lis-border-width-4 rounded mb-4 mb-md-0" alt="" />
                                <div class="media-body align-self-center">
                                    <h5 class="text-white lis-font-weight-500 lis-line-height-1"><?=$USER->name." ".$USER->fam_name?></h5>
                                    <p class="mb-0">На сайте с <?=date("F Y",strtotime($USER->registered))?></p>
                                </div>
                            </div>
                        </a>
                    </div>
                ...
                <div class="row">
                    <div class="col-12 col-xl-9 order-xl-1 order-2 text-xl-right text-center">
                        <ul class="nav nav-pills flex-column flex-sm-row lis-font-poppins" id="myTab" role="tablist">
                            <li class="nav-item ml-0"> <a class="nav-link lis-light py-4 lis-relative mr-3 active" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-expanded="true"> Профиль</a> </li>
                            <li class="nav-item ml-0"> <a class="nav-link lis-light py-4 lis-relative mr-3" data-toggle="tab" href="#listing" role="tab" aria-controls="listing"> Мои объекты</a> </li>
                            <li class="nav-item ml-0"> <a class="nav-link lis-light py-4 lis-relative mr-3" data-toggle="tab" href="#reviews" role="tab" aria-controls="reviews">Обзоры </a> </li>
                            <li class="nav-item ml-0"> <a class="nav-link lis-light py-4 lis-relative" data-toggle="tab" href="#bookmark" role="tab" aria-controls="bookmark"> Закладки</a> </li>
                        </ul>
                    </div>
                    ...
                    <div class="tab-pane fade show active" id="profile" role="tabpanel" aria-labelledby="profile">
                        <div class="row">
                            <div class="col-12 col-lg-8 mb-5 mb-lg-0">
                                <h6 class="lis-font-weight-500"><i class="fa fa-user-circle-o pr-2 lis-f-14"></i> Персональная информация</h6>
                                    ...
                                    <div class="card-body p-4">
                                        <div class="media d-md-flex d-block text-center text-md-left">
                                            ...
                                            <div class="media-body align-self-center mt-4 mt-md-0">
                                                <h5 class="mb-0 lis-font-weight-500"><a href="#" class="lis-dark"><?=$USER['name']." ".$USER['fam_name']?></a></h5>
                                                <p class="mb-0">Member since January, 2013</p>
                                                <dl class="row my-2 lis-line-height-2"> <dt class="col-xl-3 col-md-4 lis-font-weight-500 lis-dark">Address:</dt>
                                                    <dd class="col-xl-9 col-md-8">FirstStreet, New York, USA</dd> <dt class="col-xl-3 col-md-4 lis-font-weight-500 lis-dark">Phone:</dt>
                                                    <dd class="col-xl-9 col-md-8">+88 25 5894 2589</dd> <dt class="col-xl-3 col-md-4 lis-font-weight-500 lis-dark">Email:</dt>
                                                    <dd class="col-xl-9 col-md-8"><a href="#" class="lis-primary">example@domain.com</a></dd> <dt class="col-xl-3 col-md-4 lis-font-weight-500 lis-dark">Website</dt>
                                ...
                                <h6 class="lis-font-weight-500"><i class="fa fa-align-left pr-2 lis-f-14"></i> Биография</h6>
                            ...
                            <div class="col-12 col-lg-4">
                                <h6 class="lis-font-weight-500"><i class="fa fa-star pr-2 lis-f-14"></i> Рейтинг</h6>
                                <div class="card lis-brd-light wow fadeInUp mb-4">
                                    <div class="card-body p-4">
                                ...
                                <h6 class="lis-font-weight-500"><i class="fa fa-envelope pr-2 lis-f-14"></i>  Отправить сообщение</h6>
                                <div class="card lis-brd-light wow fadeInUp">
                                    <div class="card-body p-4">
                                ...
                                <div class="card lis-brd-light bg-transparent">
                                    ...
                                    <div class="card-body">
                                        <div class="media d-block d-sm-flex text-center text-sm-left">
                                            ...
                                            <div class="media-body align-self-center text-center text-sm-right mt-3 mt-sm-0"> <a href="#" class="lis-light lis-f-14" tabindex="0"><i class="fa fa-heart-o lis-id-info  lis-rounded-circle-50 text-center"></i></a> </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card lis-brd-light text-center text-lg-left">
                                    ...
                                    <div class="card-body pt-0">
                                        <div class="media d-block d-lg-flex lis-relative"> <img src="dist/images/card-logo2.png" alt="" class="lis-mt-minus-15 img-fluid d-lg-flex mx-auto mr-lg-3 mb-4 mb-lg-0 border lis-border-width-2 rounded-circle border-white" width="80">
                                            <div class="media-body align-self-start mt-2">
                                                <h6 class="mb-0 lis-font-weight-600"><a href="#" class="lis-dark" tabindex="0">Bodega Garage - Filipino Night Club</a></h6> </div>
                                        </div>
                                        <ul class="list-unstyled my-4 lis-line-height-2">
                                            <li><i class="fa fa-phone pr-2"></i> +88 25 5894 2589</li>
                                            <li><i class="fa fa-map-o pr-2"></i> First Street, New York, USA</li>
                                        ...
                                        <div class="clearfix">
                                            <div class="float-none float-lg-left mb-3 mb-lg-0 mt-1"> <a href="#" class="text-white" tabindex="0"><i class="icofont icofont-radio-mic px-2 lis-bg3 py-2 lis-rounded-circle-50 lis-f-14"></i></a> <a href="#" class="text-white" tabindex="0"><i class="icofont icofont-beer px-2 lis-bg2 py-2 lis-rounded-circle-50 lis-f-14"></i></a> <a href="#" class="lis-id-info lis-light p-2 lis-rounded-circle-50 lis-f-14" tabindex="0">1 More...</a> </div>
                                            <div class="float-none float-lg-right mt-1"> <a href="#" class="lis-light lis-f-14" tabindex="0"><i class="fa fa-envelope-o lis-id-info  lis-rounded-circle-50 text-center"></i></a> <a href="#" class="lis-light lis-f-14" tabindex="0"><i class="fa fa-heart-o lis-id-info  lis-rounded-circle-50 text-center"></i></a> <a href="#" class="lis-green-light text-white p-2 lis-rounded-circle-50 lis-f-14" tabindex="0"><i class="fa fa-star"></i> 5.0</a> </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card lis-brd-light">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body align-self-center text-right"> <a href="#" class="lis-light lis-f-14"><i class="fa fa-heart-o lis-id-info  lis-rounded-circle-50 text-center"></i></a> </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card lis-brd-light text-center text-lg-left">
                                    ...
                                    <div class="card-body pt-0">
                                        <div class="media d-block d-lg-flex lis-relative"> <img src="dist/images/card-logo3.png" alt="" class="lis-mt-minus-15  img-fluid d-lg-flex mx-auto mr-lg-3 mb-4 mb-lg-0 border lis-border-width-2 rounded-circle border-white" width="80">
                                            <div class="media-body align-self-start mt-2">
                                                <h6 class="mb-0 lis-font-weight-600"><a href="#" class="lis-dark" tabindex="0">Regal Cinemas Destiny USA 19 IMAX &amp; RPX</a></h6> </div>
                                        </div>
                                        <ul class="list-unstyled my-4 lis-line-height-2">
                                            <li><i class="fa fa-phone pr-2"></i> +88 25 5894 2589</li>
                                            <li><i class="fa fa-map-o pr-2"></i> First Street, New York, USA</li>
                                        ...
                                        <div class="clearfix">
                                            <div class="float-none float-lg-left mb-3 mb-lg-0 mt-1"> <a href="#" class="text-white" tabindex="0"><i class="icofont icofont-radio-mic px-2 lis-bg3 py-2 lis-rounded-circle-50 lis-f-14"></i></a> <a href="#" class="lis-id-info lis-light p-2 lis-rounded-circle-50 lis-f-14" tabindex="0">1 More...</a> </div>
                                            <div class="float-none float-lg-right mt-1"> <a href="#" class="lis-light lis-f-14" tabindex="0"><i class="fa fa-envelope-o lis-id-info  lis-rounded-circle-50 text-center"></i></a> <a href="#" class="lis-light lis-f-14" tabindex="0"><i class="fa fa-heart-o lis-id-info  lis-rounded-circle-50 text-center"></i></a> <a href="#" class="lis-green-light text-white p-2 lis-rounded-circle-50 lis-f-14" tabindex="0"><i class="fa fa-star"></i> 4.5</a> </div>
                                        </div>
                                    </div>
                                </div>
